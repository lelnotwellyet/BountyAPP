...
<body>
    <form runat="server">
    <h2>Welcome, Problem Posters &nbsp <asp:ImageButton ID="ImageButton1" runat="server" Height="100px" ImageUrl="~/wallet.png" Width="115px" />
                ...
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:Button ID="btnApprove" runat="server" Text="Approve"
                            ...
                            Visible='<%# Eval("Solved") != DBNull.Value && Convert.ToBoolean(Eval("Solved")) == false %>'
 />
